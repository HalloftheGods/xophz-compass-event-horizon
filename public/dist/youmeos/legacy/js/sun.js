...
function loadStarSurfaceTextures(){
	if( sunTexture === undefined ){
		sunTexture = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/sun_surface.png", undefined, window.setLoadMessage("Igniting solar plasma") );
		sunTexture.anisotropy = maxAniso;
		sunTexture.wrapS = sunTexture.wrapT = THREE.RepeatWrapping;
	}

	if( sunColorLookupTexture === undefined ){
		sunColorLookupTexture = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/star_colorshift.png" );
	}

	if( solarflareTexture === undefined ){
		solarflareTexture = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/solarflare.png", undefined, window.setLoadMessage("Distributing solar flares")	 );
	}

	if( sunHaloTexture === undefined ){
		sunHaloTexture = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/sun_halo.png", undefined, window.setLoadMessage("Calculating coronal mass") );
	}

	if( sunHaloColorTexture === undefined ){
		sunHaloColorTexture = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/halo_colorshift.png" );
	}

	if( sunCoronaTexture === undefined ){
		sunCoronaTexture = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/corona.png", undefined, window.setLoadMessage("Projecting coronal ejecta") );
	}
}
