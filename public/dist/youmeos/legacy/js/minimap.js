(function () {
  ...
  var iconBase = window.youmeosBaseUrl + "/images/icons";

  $.get(iconBase + "/sound-on.svg", function (resp) {
    $soundOn = $(resp)
      .find("svg")
      .addClass("icon")
      .css({
  ...
  $.get(iconBase + "/sound-off.svg", function (resp) {
    $soundOff = $(resp)
      .find("svg")
      .addClass("icon")
      .css({
  ...
  $.get(iconBase + "/big-tour.svg", function (resp) {
    $tour = $(resp)
      .find("svg")
      .addClass("icon")
      .attr("id", "tour-button")
    ...
    $.get(iconBase + "/heat-vision.svg", function (resp) {
      $heatvision = $(resp)
        .find("svg")
        .addClass("icon")
        .click(function (e) {
      ...
      $.get(iconBase + "/center-sun.svg", function (resp) {
        $home = $(resp)
          .find("svg")
          .addClass("icon")
