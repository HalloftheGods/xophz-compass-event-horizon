import{z as l,A as e}from"./youmeos-BSRf_rUp.js";import{l as M,q as x,d as y,A as z,e as A,p as S,w as m,t as P}from"./vendor-three-t6OjKSDq.js";import"./vendor-core-newO7ldM.js";import"./vendor-DY2cd9Br.js";import"./vendor-vuetify-By4s5Pb9.js";import"./vendor-echarts-CV97wXZ0.js";function q(p){const w=new M().load(p.youmeosBaseUrl+"/images/p_0.png"),r={color:{value:new x(16777215)},pointTexture:{value:w},scale:{value:1},opacity:{value:1}},C=new y({glslVersion:A,uniforms:r,vertexShader:`
      uniform float scale;
