...
`,Z=`# Tesseract Sovereign Node Pricing & White Glove Service
...
Each tier presentation in [\`tesseract-app.vue\`](file:///home/xopher/www/x/Xophz-COMPASS/apps/youmeos/app/sparks/tesseract/tesseract-app.vue) renders dual interactive buttons with dynamic sliding-text hover states:
...
`,ee=`# The W4 Protocol: Fractal Architecture & Civilizational Infrastructure
...
`,ne=`# YouMeOS Federated Identity Architecture
...
`,ae=`# Bazaar POS Premium Upgrades
...
`,ie=`# Sovereignty Box Architecture & Value Ladder
...
`,se=`# Compass Suite: Early Access Pricing & Marketing Proposal
...
`,re=`# Dirt: The Distributed Digital Mineral Economy
...
`,le=`# Hall of the Gods: Ecosystem Overview & Business Model
...
`,de=`# YouMeOS & COMPASS: Patent Filing Strategy & Candidate Concepts
...
`,pe=`# YouMeOS & COMPASS: The StoryBrand Framework
...
`,me=`# YouMeOS: The 10-Year Vision & StoryBrand Manifesto
...
`,ge=`# Ecosystem Email Marketing Strategy & Drip Campaigns
...
`,we=`# YouMeOS Patent Analysis: Prior Art & Sequence Diagrams
...
\`\`\`
`,be=`# Bazaar Multi-Inventory & Warehouse Stock System (COMPASS PRO)
...
`,ye=`# YouMeOS Taxonomy & Terminology
...
`,ze=`# Magic Mirror: Competitive Benchmarking & Performance Analytics
...
Search engine optimization (SEO), sitemaps, and search crawler acceleration is handled by **Pegasus Boots**.
...
| Pegasus Boots | Search engine optimization (SEO), automated XML sitemaps, smart crawlers, and schema acceleration. |
`,Re=`# Pegasus Boots System: Search Engine Optimization (SEO)

> *"Fly to the top of search engines. Bootstrap your website with intelligent search crawlers, automated sitemaps, and rich schema markup."*

## Purpose
Pegasus Boots is the premier Search Engine Optimization (SEO) and crawler acceleration engine for the COMPASS platform. It bridges SmartCrawl Pro with COMPASS, enabling automated XML sitemap generation, structured schema markup, OpenGraph social cards, SEO health audits, and rapid indexing by search engine crawlers.
...
| Component | Responsibility | Location |
|---|---|---|
| **Underlying Engine** | SmartCrawl Pro (WDS Core SEO Framework) | \`wp-content/plugins/smartcrawl-seo/\` |
| **Bedrock Styler** | Glassmorphism UI skinning, modal backdrop overlays, and button overrides | \`wp-content/mu-plugins/blackbox-bedrock/assets/css/sections/smartcrawl.css\` |
| **Vue Route** | Single-page embedded app wrapper with dynamic style injection | \`src/routes/pegasus-boots/pegasus-boots-iframe.vue\` |
| **Onboarding Registry** | Module registration under "SEO & Growth" category | \`src/routes/system/onboarding/onboarding.controller.ts\` |
| **Command Palette** | Quick-find search actions, SEO keywords, and crawler navigation | \`src/stores/command-palette.store.ts\` |

---

## Core Capabilities

### 1. Search Engine Crawler Acceleration
- Automated indexing workflows that guide search engine spiders effortlessly across the entire site architecture.
- Real-time crawler analysis to ensure critical pages are indexed while non-public routes remain protected.

### 2. Intelligent XML Sitemaps
- Automatic generation and submission of XML sitemaps for posts, pages, custom post types, and media.
- Automatic pinging to Google, Bing, and other search engines whenever new content is published.

### 3. Structured Data & Schema Markup
- Out-of-the-box JSON-LD schema generation for Articles, Local Businesses, FAQs, How-Tos, and Products.
- Rich snippet optimization for search engine results pages (SERPs).

### 4. Social Card & OpenGraph Optimization
- Tailored meta titles, descriptions, and OpenGraph / Twitter Card preview images per page and post.
- Automated fallback fallbacks to prevent broken social embeds.

### 5. SEO Health Audits & Content Analysis
- Inline content analysis checks keyword density, readability, title lengths, and image alt attributes.
- Suite-wide SEO health check reports with actionable remediation recommendations.

---

## Aesthetic Integration

Pegasus Boots is styled via Blackbox Bedrock to match the COMPASS futuristic glassmorphic design language:
- **Container Glass**: Smooth frosted dark glass with standard COMPASS radius and subtle borders.
- **Modals & Dialogs**: Viewport-wide dark scrim mask (\`rgba(5, 8, 14, 0.88)\` with 16px blur) and solid dark glass window boxes (\`rgba(13, 18, 29, 0.96)\`) to eliminate background text bleed.
- **Buttons**: Gold primary action buttons with crisp white text (\`#ffffff\`) and subtle drop shadows for accessibility.
`,Ie=`# Performance Widget System
...
`,De=`# POLOS: The Fractal Governance & Consensus Engine

## Overview
**POLOS** (Greek *Pólos*, the celestial axis and True North pivot) is a multi-scale fractal consensus engine for the COMPASS ecosystem and YouMeOS. It scales governance from the sovereign individual to student pods, university faculties, municipal townships, and planetary networks through quadratic voting, liquid proxy delegation, Circle Web-of-Trust (WoT), and the federated $w^4$ Protocol.

---

## Architectural Philosophy: The Federated Fractal

\`\`\`
Layer 6: Globe / Gaia          (w⁴ Federated Hive Mesh)
       ▲
Layer 5: Bioregion             (w⁴ Cross-Node Peering)
──────────────────────────────────────────────────────────  [FEDERATED BOUNDARY]
Layer 4: Polis                 (Local COMPASS Node Instance)
       ▲
Layer 3: Guild                 (Departments / Co-ops)
       ▲
Layer 2: Circle / Pod          (15-Person Dunbar Web-of-Trust)
       ▲
Layer 1: Sovereign Self        (Local Cryptographic Keypair)
\`\`\`

### 1. The Federated Boundary
A single COMPASS installation operates strictly at the **Local Node** level (Layers 1 to 4: Self -> Circle -> Guild -> Polis). It does not store planetary data. For Layers 5 (Bioregion) and 6 (Globe/Gaia), the system utilizes a federated "hive" model. Individual Polis nodes communicate cross-instance via the $w^4$ Protocol, aggregating quadratic tallies and liquid proxies across the YouMeOS network without centralizing data or identity.

### 2. Core Architectural Pillars
* **Data Sovereignty:** A university, co-op, or municipal district owns 100% of its internal records, user credentials, and deliberation data.
* **Infinite Scalability:** WordPress and local database engines process only local transactions; macro consensus is federated across independent COMPASS nodes.
* **Cross-Node Liquid Democracy:** Citizens can delegate voting power to specialists in neighboring nodes via $w^4$ proxy tunnels without merging local databases.

---

## The $w^4$ Protocol Communication Layer

### 1. The Trust Bridge: \`POST /xophz-polos/v1/federation/handshake\`
Establishes an asymmetric key exchange (Ed25519/RSA) with timestamp and nonce replay protection:
...
\`\`\`json
{
  ...
  "node": {
    ...
    "w4_address": "https://compass.tucson-coop.org/wp-json/xophz-polos/v1",
    "public_key": "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAI...",
    "scope_tier": 4,
    "metadata": {
      "name": "Tucson Desert Co-op",
      "bioregion_tag": "sonoran-desert",
      "active_citizens": 1450
    }
  },
  "auth": {
    "timestamp": 1723957200,
    "nonce": "a7b8c9d0e1f2",
    "signature": "BASE64_ENCODED_SIGNATURE_OF_PAYLOAD"
  }
}
\`\`\`

### 2. The Consensus Push: \`POST /xophz-polos/v1/federation/sync-tally\`
Transmits democratic spread (\`quadratic_votes\` and \`voice_credits_spent\`) accompanied by a cryptographic Merkle Root for receipt auditability with zero PII exposure:

\`\`\`json
{
  "initiative_id": "global-ballot-99a1f2bc",
  "node_id": "polis-5f8a2b9e-4c11-4b7d",
  "sync_type": "final_tally",
  "tallies": [
    {
      "option_id": "opt_funding_solar",
      "quadratic_votes": 142.5,
      "voice_credits_spent": 8450.25,
      "unique_voter_count": 89
    },
    {
      "option_id": "opt_funding_water",
      "quadratic_votes": 85.0,
      "voice_credits_spent": 3100.00,
      "unique_voter_count": 42
    }
  ],
  "audit": {
    "merkle_root": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
    "timestamp": 1723958500,
    "signature": "BASE64_ENCODED_SIGNATURE_OF_TALLIES"
  }
}
\`\`\`
...
## Overview
The transition of YouMeOS toward a model of **Individual Sovereignty and Collective Unity** requires a concrete mechanism for users to own their data, track digital asset equity, and receive tangible value for their participation. The **Treasure Trove** and **Treasure Map** plugins act as the core architectural pillars for this vision.

* **Treasure Trove (The Sovereign Vault)**: The user's centralized sovereign valuation vault and encrypted personal data locker. It aggregates real-time equity across Commerce, CRM pipelines, and Search intelligence.
* **Treasure Map (The Strategic Discovery & ROI Journey)**: The gamified discovery and ROI optimization engine. It points users across COMPASS waypoints, binds to real platform telemetry feeds, and compounds total platform valuation.
...
1. **Overview Dashboard (\`/treasure-trove\`)**: Executive Sovereign Valuation Hero Meter ($ valuation total, sync action, 3 equity pillars, telemetry stream).
2. **Commerce Vault (\`/treasure-trove/commerce\`)**: Bazaar & WooCommerce run-rate valuation, AOV, order volume, inventory stock value, and tracking methodology.
3. **Pipeline Equity (\`/treasure-trove/pipeline\`)**: Questbook CRM contacts, consultation booking velocity, conversion multipliers, and deal values.
4. **Search Capital (\`/treasure-trove/traffic\`)**: Enchanted Mirror domain intelligence, Open PageRank multipliers, Golden Keys keyword portfolio worth, and organic search share.
5. **Sovereign Ledger (\`/treasure-trove/ledger\`)**: Client-side encrypted data locker, identity/chronicle clusters, granular privacy switches, and passive Noosphere XP dividend yield.
6. **Valuation Formula Sandbox (\`/treasure-trove/formula\`)**: Interactive calculation sandbox with real-time sliders and a complete mathematical audit table.

### Treasure Map (\`/treasure-map\`)
1. **Quest Journey (\`/treasure-map\`)**: Interactive winding Quest Map with animated SVG curves, direct action launch buttons, and XP reward claims.
2. **Telemetry Radar (\`/treasure-map/telemetry\`)**: Central data sources hub detailing every connected REST endpoint, polling frequency, latency, tracked metrics, and data sovereignty guarantees.
3. **Milestones Matrix (\`/treasure-map/milestones\`)**: Tier progression ($10k Starter, $50k Builder, $100k Pro, $250k Sovereign, $1M Titan) with unlocked capabilities and XP claims.
4. **ROI Compounding Simulator (\`/treasure-map/roi-calculator\`)**: Interactive projection simulator illustrating how completing each quest directly scales total platform valuation.
5. **True North Guide (\`/treasure-map/compass-guide\`)**: Strategic recommendation engine analyzing live telemetry to highlight the next highest-ROI actions.

---

## 2. Telemetry Grounding & Mathematical Valuation Model

Valuation is calculated using deterministic formulas grounded in live COMPASS data feeds:

| Equity Pillar | Connected COMPASS Service | Endpoint | Mathematical Formula |
| :--- | :--- | :--- | :--- |
| **Commerce Equity** | Bazaar / WooCommerce | \`/wp-json/wc/v3/reports/sales\` | \`(Monthly GMV × 12) + (Inventory Value × 0.50)\` |
| **CRM Pipeline Equity** | Questbook CRM | \`/wp-json/xophz-compass/v1/questbook\` | \`(Monthly Appts × 12 × ApptValue) + (Contacts × $50) + Open Deals\` |
| **Search Capital** | Enchanted Mirror & Golden Keys | \`/wp-json/xophz-compass/v1/enchanted-mirror\` | \`(Monthly Visits × 12 / 1000 × $25 RPM) + (PageRank × $1,500) + (Keys × $35)\` |
| **Directory Authority** | Yellow Links Network | \`/wp-json/xophz-compass/v1/yellow-links\` | \`(Directory Citations × $75) + (Backlink Score × $50)\` |
| **Sovereign Defense** | Mirror Shield Defender | \`/wp-json/xophz-compass/v1/mirror-shield\` | \`Base Security ($2,500) + (Tweaks Resolved × $150)\` |

$$\\text{Total Sovereign Valuation} = \\text{Commerce} + \\text{Pipeline} + \\text{Search} + \\text{Authority} + \\text{Defense}$$

---

## 3. Data Sovereignty & Encryption

* **Client-Side Master Key**: Identity records and chronicle logs are encrypted client-side using \`AES-GCM-256\`.
* **Zero External Leakage**: Telemetry queries are localized to the user's sovereign WordPress installation.
* **Noosphere Data Dividends**: Users opting into anonymous behavioral intelligence sharing earn passive daily XP yields (+75 XP/day).
...
`,Xe=`# XP & Bells Progression Engine for PRO Accounts
...
`,Fe=`# My Compass Media Library (\`o-media-library-modal\`)
...
`,Ne=`# The Hall of the Gods Ecosystem Architecture
...
`,He=`# PROJECT COMPASS // KNOWLEDGE BASE NEXUS
...
`,Qe=`# YouMeOS Nomenclature & Terminology Map
...
`,$e=`# YouMeOS: Universal Internet Operating System Vision & Architecture
...
`,en=`# Spark Federation Protocol & Security Architecture
...
`,on=`# YouMeOS: The Asynchronous Cosmos
...
`,an=`# YouMeOS: The Sovereign Node Architecture
...
| \`<x-search-field>\` | \`<v-text-field>\`   | Reusable glass search bar with shortcuts, clear action, and glowing focus |
| \`<x-search-bar>\`   | \`<v-text-field>\`   | Alias primitive for \`<x-search-field>\`  |
...
`,pn=`# Sub-App Layout & Bazaar Routing Investigation
...
`,mn=`# YouMeOS: The 4D Tesseract Visualization Plan
...
`,gn=`# Three.js Legacy Migration Guide
...
`,wn=`# YouMeOS Web3 Vision & Roadmap
...
`,yn=`# WebGPU Shader Migration Plan
...
`,vn=`# Window Management & Workspace Orchestration Roadmap
...
`,fn=`# YouMeOS Decentralization & Local-First Architecture Roadmap
...
## Details
This spark operates natively within the YouMeOS environment, providing seamless integration with the glassmorphic desktop and True North aesthetics.
`,ct=`# Getting Started with YouMeOS
...
`,pt=`# The Swiss Army Knife for Life
...
`,ut=`# YouMeOS & My Compass Software Suite: Official Architectural Whitepaper
...
- Selection clears on mode switch or folder navigation
`,mt=["innerHTML"],gt=D({__name:"x-markdown",props:{content:{}},setup(k){const c=k,b=h(()=>c.content?U.parse(c.content):"");return(r,P)=>(w(),E("div",{class:"x-markdown-container",innerHTML:b.value},null,8,mt))}}),wt=I(gt,[["__scopeId","data-v-c9651a1d"]]),bt={class:"h-100 w-100",style:{position:"relative"}},yt={class:"reading-pane mx-auto w-100 brand-styled-content"},vt="../../../../../docs/",ft=D({__name:"enchiridion-app",setup(k){const c=Object.assign({"../../../../../docs/Bomb-Bag-System.md":j,"../../../../../docs/CHANGELOG.md":q,"../../../../../docs/Cloudflare-Email-Routing.md":Q,"../../../../../docs/Design-Tokens.md":$,"../../../../../docs/Hello-World.md":K,"../../../../../docs/Project-Philosophy.md":J,"../../../../../docs/Tesseract-Pricing-and-White-Glove-Service.md":Z,"../../../../../docs/The-W4-Protocol-and-Fractal-OS.md":ee,"../../../../../docs/YouMeOS-Federated-Identity.md":ne,"../../../../../docs/analytics_google-analytics-integration.md":te,"../../../../../docs/authenticity_and_licensing.md":oe,"../../../../../docs/bazaar_pos_premium-upgrades.md":ae,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":ie,"../../../../../docs/business/business_compass_pricing_proposal.md":se,"../../../../../docs/business/business_dirt_digital_mineral_economy.md":re,"../../../../../docs/business/business_ecosystem_overview.md":le,"../../../../../docs/business/business_patent_strategy.md":de,"../../../../../docs/business/business_sephiroth_godhead_progression.md":ce,"../../../../../docs/business/business_storybrand_framework.md":pe,"../../../../../docs/business/business_w4_protocol_economy.md":ue,"../../../../../docs/business/business_youmeos_decentralized_pwa_model.md":he,"../../../../../docs/business/business_youmeos_storybrand_manifesto.md":me,"../../../../../docs/business/marketing_drip_campaigns.md":ge,"../../../../../docs/business/patent_diagrams_and_prior_art.md":we,"../../../../../docs/compass/bazaar_multi_inventory_system.md":be,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":ye,"../../../../../docs/compass/blueprints/System-Overview.md":ve,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":fe,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":Se,"../../../../../docs/compass/ecosystem/software_manager.md":xe,"../../../../../docs/compass/plugins/Bazaar-POS-System.md":ke,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":Pe,"../../../../../docs/compass/plugins/Bug-Net-System.md":Ae,"../../../../../docs/compass/plugins/Hookshot-System.md":Ce,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":Me,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":Te,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":ze,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":Oe,"../../../../../docs/compass/plugins/Moving-Castle-System.md":_e,"../../../../../docs/compass/plugins/Pegasus-Boots-System.md":Re,"../../../../../docs/compass/plugins/Performance-Widget-System.md":Ie,"../../../../../docs/compass/plugins/Polos-Consensus-System.md":De,"../../../../../docs/compass/plugins/Questbook-CRM-System.md":Ee,"../../../../../docs/compass/plugins/Silver-Arrow-System.md":We,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":Le,"../../../../../docs/compass/plugins/magic-formula-system.md":Be,"../../../../../docs/compass/xp-pro-features.md":Xe,"../../../../../docs/compass_media_library_system.md":Fe,"../../../../../docs/github-plugin-updater.md":Ue,"../../../../../docs/moving-castle_magic-door.md":Ge,"../../../../../docs/reference/Ecosystem-Architecture.md":Ne,"../../../../../docs/reference/Home.md":He,"../../../../../docs/reference/Project-Philosophy.md":Ve,"../../../../../docs/reference/versioning.md":Ye,"../../../../../docs/spark_wizards-tower_feature-flags.md":je,"../../../../../docs/sparks_omegafile.md":qe,"../../../../../docs/youmeos/Nomenclature-Mapping.md":Qe,"../../../../../docs/youmeos/Universal-OS-Vision.md":$e,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":Ke,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":Je,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":Ze,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":en,"../../../../../docs/youmeos/blueprints/Starmap-and-Federation-Blueprint.md":nn,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":tn,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":on,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":an,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":sn,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":rn,"../../../../../docs/youmeos/design-system/Component-Architecture.md":ln,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":dn,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":cn,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":pn,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":un,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":hn,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":mn,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":gn,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":wn,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":bn,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":yn,"../../../../../docs/youmeos/roadmaps/Window-Management.md":vn,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":fn,"../../../../../docs/youmeos/spark-plugs/blackbox.md":Sn,"../../../../../docs/youmeos/spark-plugs/blackjack.md":xn,"../../../../../docs/youmeos/spark-plugs/bubblegum.md":kn,"../../../../../docs/youmeos/spark-plugs/bugnet.md":Pn,"../../../../../docs/youmeos/spark-plugs/cafeteria.md":An,"../../../../../docs/youmeos/spark-plugs/calculator.md":Cn,"../../../../../docs/youmeos/spark-plugs/chronos.md":Mn,"../../../../../docs/youmeos/spark-plugs/cookie-jar.md":Tn,"../../../../../docs/youmeos/spark-plugs/debug-console.md":zn,"../../../../../docs/youmeos/spark-plugs/enchiridion.md":On,"../../../../../docs/youmeos/spark-plugs/gaea.md":_n,"../../../../../docs/youmeos/spark-plugs/helios.md":Rn,"../../../../../docs/youmeos/spark-plugs/holosweeper.md":In,"../../../../../docs/youmeos/spark-plugs/jukebox.md":Dn,"../../../../../docs/youmeos/spark-plugs/local-produce.md":En,"../../../../../docs/youmeos/spark-plugs/logos.md":Wn,"../../../../../docs/youmeos/spark-plugs/lunch-room.md":Ln,"../../../../../docs/youmeos/spark-plugs/midnight-nerd.md":Bn,"../../../../../docs/youmeos/spark-plugs/neon-notes.md":Xn,"../../../../../docs/youmeos/spark-plugs/nexus.md":Fn,"../../../../../docs/youmeos/spark-plugs/noosphere.md":Un,"../../../../../docs/youmeos/spark-plugs/notepad.md":Gn,"../../../../../docs/youmeos/spark-plugs/omega-source.md":Nn,"../../../../../docs/youmeos/spark-plugs/paint.md":Hn,"../../../../../docs/youmeos/spark-plugs/snake.md":Vn,"../../../../../docs/youmeos/spark-plugs/social-preview.md":Yn,"../../../../../docs/youmeos/spark-plugs/solitaire.md":jn,"../../../../../docs/youmeos/spark-plugs/spark-plugs.md":qn,"../../../../../docs/youmeos/spark-plugs/suggestion-box.md":Qn,"../../../../../docs/youmeos/spark-plugs/sys-monitor.md":$n,"../../../../../docs/youmeos/spark-plugs/take-my-money.md":Kn,"../../../../../docs/youmeos/spark-plugs/telescope.md":Jn,"../../../../../docs/youmeos/spark-plugs/terminal.md":Zn,"../../../../../docs/youmeos/spark-plugs/tesseract.md":et,"../../../../../docs/youmeos/spark-plugs/tourguide.md":nt,"../../../../../docs/youmeos/spark-plugs/trenchess.md":tt,"../../../../../docs/youmeos/spark-plugs/trophy-case.md":ot,"../../../../../docs/youmeos/spark-plugs/u-nucleos.md":at,"../../../../../docs/youmeos/spark-plugs/welcome-u.md":it,"../../../../../docs/youmeos/spark-plugs/wizards-tower.md":st,"../../../../../docs/youmeos/spark-plugs/wp-admin.md":rt,"../../../../../docs/youmeos/spark-plugs/xophz-lemonade-stand.md":lt,"../../../../../docs/youmeos/spark-plugs/xophz-magic-formula.md":dt,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":ct,"../../../../../docs/youmeos/user-guides/youmeos_user_guides_swiss_army_knife.md":pt,"../../../../../docs/youmeos/youmeos_compass_whitepaper.md":ut,"../../../../../docs/youmeos_nimbus_interaction-modes.md":ht}),b=n=>{const e=n.toLowerCase();return e.includes("start here")?"fal fa-stars":e.includes("blueprints")?"fal fa-drafting-compass":e.includes("user guides")?"fal fa-map-signs":e.includes("core engine")?"fal fa-microchip":e.includes("design system")?"fal fa-swatchbook":e.includes("roadmaps")?"fal fa-road":e.includes("ecosystem")?"fal fa-planet-ringed":e.includes("plugins")||e.includes("sparks")?"fal fa-plug":e.includes("reference")?"fal fa-books":e.includes("general")?"fal fa-book-spells":"fal fa-folder"},r=h(()=>Object.keys(c).map(n=>{const e=n.replace(vt,""),t=e.split("/"),o=t.pop()||"",a=o.replace(".md","");let l=a.split("-").map(p=>p.charAt(0).toUpperCase()+p.slice(1)).join(" "),u="03. Platform Docs",m="General";const L=o.toLowerCase()==="hello-world.md",B=t.length>=2&&["compass","youmeos"].includes(t[0].toLowerCase());L?(u="00. Welcome",m="Start Here"):B?(u=t[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",m=t[1]):t.length>0&&(u="03. Platform Docs",m=t[0]);const z=m.replace(/[-_]/g," ").split(" ").map(p=>p.charAt(0).toUpperCase()+p.slice(1).toLowerCase()).join(" ");let v="fal fa-file-alt",f="#62c9ff";if(z.toLowerCase()==="sparks"){const g=F().apps.find(X=>X.id===a);g&&(v=g.icon||v,f=g.color||f,l=g.title||l)}return{path:n,relativePath:e,title:l,category:z,root:u,icon:v,color:f}}).sort((n,e)=>n.root!==e.root?n.root.localeCompare(e.root):n.category!==e.category?n.category.localeCompare(e.category):n.title.localeCompare(e.title))),P=h(()=>{const n={};return r.value.forEach(e=>{const t=`${e.root}/${e.category}`;n[t]||(n[t]=[]),n[t].push(e)}),Object.keys(n).sort().map(e=>{const t=n[e],o=t[0].category;return{id:e,title:o,icon:b(o),children:t.map(a=>({id:a.path,title:a.title,icon:a.icon}))}})}),i=R("splash"),A=h(()=>r.value.find(n=>n.path===i.value)),C=h(()=>i.value==="splash"||!c[i.value]?null:c[i.value]),y=R(null);G(i,()=>{y.value&&(y.value.scrollTop=0)},{flush:"post"});const W=n=>{if(!n)return null;const e=n.toLowerCase(),t=e.replace(/^u-/,"").replace(/^xophz-/,"").replace(/\.md$/,"");let o=r.value.find(a=>(a.relativePath.split("/").pop()?.replace(".md","").toLowerCase()||"")===e);return o||(o=r.value.find(a=>(a.relativePath.split("/").pop()?.replace(".md","").toLowerCase()||"").replace(/^u-/,"").replace(/^xophz-/,"")===t),o)||(o=r.value.find(a=>a.path.toLowerCase().includes(e)||a.path.toLowerCase().includes(t)),o)?o:(o=r.value.find(a=>a.title.toLowerCase().includes(t)),o||null)},M=n=>{const e=W(n);e&&(i.value=e.path)},T=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;return T&&(M(T),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")),typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",n=>{const e=n.detail;e&&M(e)}),(n,e)=>{const t=S("x-spark-splash-action"),o=S("t-spark-splash"),a=S("u-window");return w(),O(a,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","brand-color":"#62c9ff",width:1e3,height:700,"default-nav-pinned":"","nav-items":P.value,"active-nav":i.value,"onUpdate:activeNav":e[0]||(e[0]=l=>i.value=l)},{"app-bar-title":d(()=>[H(V(A.value?.title||"Enchiridion"),1)]),default:d(()=>[_("div",bt,[C.value?(w(),E("div",{key:1,ref_key:"contentScrollEl",ref:y,class:"enchiridion-content fill-height custom-scrollbar",style:N({"--brand-color":A.value?.color||"#62c9ff"})},[_("div",yt,[s(wt,{content:C.value},null,8,["content"])])],4)):(w(),O(o,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:d(()=>[s(Y)]),actions:d(()=>[s(x,{cols:"12",sm:"4"},{default:d(()=>[s(t,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),s(x,{cols:"12",sm:"4"},{default:d(()=>[s(t,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),s(x,{cols:"12",sm:"4"},{default:d(()=>[s(t,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1},8,["nav-items","active-nav"])}}}),zt=I(ft,[["__scopeId","data-v-3177f1f2"]]);export{zt as default};
