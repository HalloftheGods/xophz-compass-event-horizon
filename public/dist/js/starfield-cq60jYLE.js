import{w as l,x as e}from"./youmeos-ljoleO5e.js";import{l as M,q as x,d as y,A as z,e as A,p as S,w as m,t as P}from"./vendor-three-CRwamiEG.js";import"./vendor-core-DeRgPM_0.js";import"./vendor-Bw-uNOII.js";import"./vendor-vuetify-7Mr5D4Q-.js";import"./vendor-echarts-BrclVJOm.js";function q(p){const w=new M().load(p.youmeosBaseUrl+"/images/p_0.png"),r={color:{value:new x(16777215)},pointTexture:{value:w},scale:{value:1},opacity:{value:1}},C=new y({glslVersion:A,uniforms:r,vertexShader:`
      uniform float scale;
