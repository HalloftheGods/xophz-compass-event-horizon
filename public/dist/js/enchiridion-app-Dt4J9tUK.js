import{_ as z,N}from"./youmeos-BSRf_rUp.js";import{f as E,ce as w,cc as F,e as b,cK as H,W as A,cf as D,v as V,ci as y,q as L,j as h,n as Y,Y as j,J as X,b as B}from"./vendor-DY2cd9Br.js";import{p as R}from"./vendor-vuetify-By4s5Pb9.js";import"./vendor-core-newO7ldM.js";import"./vendor-three-t6OjKSDq.js";import"./vendor-echarts-CV97wXZ0.js";const q=`# Bomb Bag System (Email Marketing & CRM)
...
`,Z=`# Project Philosophy: YouMeOS Design & UX Principles
...
`,ye=`# YouMeOS Patent Analysis: Prior Art & Sequence Diagrams
...
\`\`\`
`,fe=`# YouMeOS Taxonomy & Terminology
...
`,We=`# XP & Bells Progression Engine for PRO Accounts
...
`,pn=`# YouMeOS Web3 Vision & Roadmap
...
## Details
This spark operates natively within the YouMeOS environment, providing seamless integration with the glassmorphic desktop and True North aesthetics.
`,it=`# Getting Started with YouMeOS
...
- Selection clears on mode switch or folder navigation
`,lt=["innerHTML"],dt=E({__name:"x-markdown",props:{content:{}},setup(x){const c=x,p=b(()=>c.content?H.parse(c.content):"");return(l,S)=>(w(),F("div",{class:"x-markdown-container",innerHTML:p.value},null,8,lt))}}),ct=z(dt,[["__scopeId","data-v-c9651a1d"]]),pt=80,u=150,O=200,ht=E({__name:"enchiridion-canvas",setup(x){let c=!1,p=-1e3,l=-1e3;function S(s,n){const e=Math.random()>.85;return{x:Math.random()*s,y:Math.random()*n,vx:(Math.random()-.5)*.6,vy:(Math.random()-.5)*.6,radius:e?3+Math.random()*3:1+Math.random()*1.5,baseRadius:e?3.5:1.5,hue:e?45:200,pulsePhase:Math.random()*Math.PI*2,pulseSpeed:.02+Math.random()*.03}}const i=[],k=s=>{const n=s.currentTarget;if(!n)return;const e=n.getBoundingClientRect();p=s.clientX-e.left,l=s.clientY-e.top},P=()=>{p=-1e3,l=-1e3};let m=0,v=0;const T=({canvas:s,ctx:n})=>{if(!c){for(let e=0;e<pt;e++)i.push(S(s.width,s.height));m=s.width,v=s.height,c=!0}if(m<20&&s.width>50||v<20&&s.height>50)for(const e of i)e.x=Math.random()*s.width,e.y=Math.random()*s.height;m=s.width,v=s.height,n.clearRect(0,0,s.width,s.height);for(const e of i){e.x+=e.vx,e.y+=e.vy,e.pulsePhase+=e.pulseSpeed,e.radius=e.baseRadius+Math.sin(e.pulsePhase)*(e.baseRadius*.4),e.x<0&&(e.x=s.width),e.x>s.width&&(e.x=0),e.y<0&&(e.y=s.height),e.y>s.height&&(e.y=0);const t=e.x-p,o=e.y-l,a=Math.sqrt(t*t+o*o);if(a<O&&a>.1){const d=(O-a)/O;e.vx+=t/a*d*.03,e.vy+=o/a*d*.03}const r=Math.sqrt(e.vx*e.vx+e.vy*e.vy);r>1.2?(e.vx*=.95,e.vy*=.95):r<.2&&(e.vx*=1.05,e.vy*=1.05)}for(let e=0;e<i.length;e++){for(let a=e+1;a<i.length;a++){const r=i[e].x-i[a].x,d=i[e].y-i[a].y;if(Math.abs(r)>u||Math.abs(d)>u)continue;const g=Math.sqrt(r*r+d*d);if(g<u){const M=1-g/u;n.beginPath(),n.moveTo(i[e].x,i[e].y),n.lineTo(i[a].x,i[a].y),n.strokeStyle=`rgba(98, 201, 255, ${M*.25})`,n.lineWidth=1,n.stroke()}}const t=i[e].x-p,o=i[e].y-l;if(Math.abs(t)<u*1.5&&Math.abs(o)<u*1.5){const a=Math.sqrt(t*t+o*o);if(a<u*1.5){const r=1-a/(u*1.5);n.beginPath(),n.moveTo(i[e].x,i[e].y),n.lineTo(p,l),n.strokeStyle=`rgba(217, 190, 111, ${r*.4})`,n.lineWidth=1.5,n.stroke()}}}for(const e of i){if(e.radius<=0)continue;n.beginPath(),n.arc(e.x,e.y,e.radius,0,Math.PI*2),n.fillStyle=`hsla(${e.hue}, 80%, 70%, 0.8)`,n.fill();const t=e.radius*3.5;n.beginPath(),n.arc(e.x,e.y,t,0,Math.PI*2);const o=n.createRadialGradient(e.x,e.y,e.radius,e.x,e.y,t);o.addColorStop(0,`hsla(${e.hue}, 80%, 60%, 0.4)`),o.addColorStop(1,`hsla(${e.hue}, 80%, 60%, 0)`),n.fillStyle=o,n.fill()}};return(s,n)=>{const e=A("x-canvas");return w(),D(e,{render:T,onMousemove:k,onMouseleave:P,class:"enchiridion-canvas"})}}}),ut=z(ht,[["__scopeId","data-v-c8f9f032"]]),mt={class:"h-100 w-100",style:{position:"relative"}},gt={class:"reading-pane mx-auto w-100 brand-styled-content"},yt="../../../../../docs/",ft=E({__name:"enchiridion-app",setup(x){const c=Object.assign({"../../../../../docs/Bomb-Bag-System.md":q,"../../../../../docs/CHANGELOG.md":Q,"../../../../../docs/Cloudflare-Email-Routing.md":K,"../../../../../docs/Design-Tokens.md":$,"../../../../../docs/Hello-World.md":J,"../../../../../docs/Project-Philosophy.md":Z,"../../../../../docs/The-W4-Protocol-and-Fractal-OS.md":ee,"../../../../../docs/YouMeOS-Federated-Identity.md":ne,"../../../../../docs/analytics_google-analytics-integration.md":te,"../../../../../docs/authenticity_and_licensing.md":ae,"../../../../../docs/bazaar_pos_premium-upgrades.md":oe,"../../../../../docs/business/BOX_TIER_ARCHITECTURE.md":ie,"../../../../../docs/business/business_compass_pricing_proposal.md":se,"../../../../../docs/business/business_dirt_digital_mineral_economy.md":re,"../../../../../docs/business/business_ecosystem_overview.md":le,"../../../../../docs/business/business_patent_strategy.md":de,"../../../../../docs/business/business_sephiroth_godhead_progression.md":ce,"../../../../../docs/business/business_storybrand_framework.md":pe,"../../../../../docs/business/business_w4_protocol_economy.md":he,"../../../../../docs/business/business_youmeos_decentralized_pwa_model.md":ue,"../../../../../docs/business/business_youmeos_storybrand_manifesto.md":me,"../../../../../docs/business/marketing_drip_campaigns.md":ge,"../../../../../docs/business/patent_diagrams_and_prior_art.md":ye,"../../../../../docs/compass/blueprints/Core-Taxonomy.md":fe,"../../../../../docs/compass/blueprints/System-Overview.md":ve,"../../../../../docs/compass/ecosystem/Patreon-and-Bazaar.md":be,"../../../../../docs/compass/ecosystem/Portals-and-Ecosystem.md":we,"../../../../../docs/compass/ecosystem/software_manager.md":Se,"../../../../../docs/compass/plugins/Bazaar-POS-System.md":ke,"../../../../../docs/compass/plugins/Bomb-Bag-System.md":Pe,"../../../../../docs/compass/plugins/Bug-Net-System.md":Te,"../../../../../docs/compass/plugins/Hookshot-System.md":Ce,"../../../../../docs/compass/plugins/Lemon-Aid-System.md":Ae,"../../../../../docs/compass/plugins/Magic-Cloak-System.md":xe,"../../../../../docs/compass/plugins/Magic-Mirror-System.md":Me,"../../../../../docs/compass/plugins/Mirror-Shield-System.md":_e,"../../../../../docs/compass/plugins/Moving-Castle-System.md":Ie,"../../../../../docs/compass/plugins/Performance-Widget-System.md":Re,"../../../../../docs/compass/plugins/Questbook-CRM-System.md":Oe,"../../../../../docs/compass/plugins/Silver-Arrow-System.md":De,"../../../../../docs/compass/plugins/Treasure-Trove-and-Map-System.md":ze,"../../../../../docs/compass/plugins/magic-formula-system.md":Ee,"../../../../../docs/compass/xp-pro-features.md":We,"../../../../../docs/github-plugin-updater.md":Le,"../../../../../docs/moving-castle_magic-door.md":Be,"../../../../../docs/reference/Ecosystem-Architecture.md":Fe,"../../../../../docs/reference/Project-Philosophy.md":Ue,"../../../../../docs/reference/versioning.md":Ge,"../../../../../docs/spark_wizards-tower_feature-flags.md":Ne,"../../../../../docs/sparks_omegafile.md":He,"../../../../../docs/youmeos/Nomenclature-Mapping.md":Ve,"../../../../../docs/youmeos/Universal-OS-Vision.md":Ye,"../../../../../docs/youmeos/blueprints/Helios-Modules.md":je,"../../../../../docs/youmeos/blueprints/Legacy-Engine-Mechanics.md":Xe,"../../../../../docs/youmeos/blueprints/OS-Architecture.md":qe,"../../../../../docs/youmeos/blueprints/Spark-Federation-Security.md":Qe,"../../../../../docs/youmeos/blueprints/Starmap-and-Federation-Blueprint.md":Ke,"../../../../../docs/youmeos/blueprints/Unified-Contacts-Blueprint.md":$e,"../../../../../docs/youmeos/core-engine/Asynchronous-Cosmos.md":Je,"../../../../../docs/youmeos/core-engine/PWA-Desktop-Node.md":Ze,"../../../../../docs/youmeos/core-engine/Sovereign-Identity.md":en,"../../../../../docs/youmeos/core-engine/YouMeOS-Engine.md":nn,"../../../../../docs/youmeos/design-system/Component-Architecture.md":tn,"../../../../../docs/youmeos/design-system/Component-Refactoring-Guide.md":an,"../../../../../docs/youmeos/design-system/Design-System-Atoms.md":on,"../../../../../docs/youmeos/design-system/Sub-App-Layout.md":sn,"../../../../../docs/youmeos/roadmaps/General-Roadmap.md":rn,"../../../../../docs/youmeos/roadmaps/Migration-Progress.md":ln,"../../../../../docs/youmeos/roadmaps/Tesseract-4D-Visualization.md":dn,"../../../../../docs/youmeos/roadmaps/ThreeJS-Legacy-Migration.md":cn,"../../../../../docs/youmeos/roadmaps/Web3-Vision-Roadmap.md":pn,"../../../../../docs/youmeos/roadmaps/WebGPU-Migration.md":hn,"../../../../../docs/youmeos/roadmaps/WebGPU-Shader-Migration.md":un,"../../../../../docs/youmeos/roadmaps/Window-Management.md":mn,"../../../../../docs/youmeos/roadmaps/YouMeOS-Decentralization-Roadmap.md":gn,"../../../../../docs/youmeos/spark-plugs/blackbox.md":yn,"../../../../../docs/youmeos/spark-plugs/blackjack.md":fn,"../../../../../docs/youmeos/spark-plugs/bubblegum.md":vn,"../../../../../docs/youmeos/spark-plugs/bugnet.md":bn,"../../../../../docs/youmeos/spark-plugs/cafeteria.md":wn,"../../../../../docs/youmeos/spark-plugs/calculator.md":Sn,"../../../../../docs/youmeos/spark-plugs/chronos.md":kn,"../../../../../docs/youmeos/spark-plugs/cookie-jar.md":Pn,"../../../../../docs/youmeos/spark-plugs/debug-console.md":Tn,"../../../../../docs/youmeos/spark-plugs/enchiridion.md":Cn,"../../../../../docs/youmeos/spark-plugs/gaea.md":An,"../../../../../docs/youmeos/spark-plugs/helios.md":xn,"../../../../../docs/youmeos/spark-plugs/holosweeper.md":Mn,"../../../../../docs/youmeos/spark-plugs/jukebox.md":_n,"../../../../../docs/youmeos/spark-plugs/local-produce.md":In,"../../../../../docs/youmeos/spark-plugs/logos.md":Rn,"../../../../../docs/youmeos/spark-plugs/lunch-room.md":On,"../../../../../docs/youmeos/spark-plugs/midnight-nerd.md":Dn,"../../../../../docs/youmeos/spark-plugs/neon-notes.md":zn,"../../../../../docs/youmeos/spark-plugs/nexus.md":En,"../../../../../docs/youmeos/spark-plugs/noosphere.md":Wn,"../../../../../docs/youmeos/spark-plugs/notepad.md":Ln,"../../../../../docs/youmeos/spark-plugs/omega-source.md":Bn,"../../../../../docs/youmeos/spark-plugs/paint.md":Fn,"../../../../../docs/youmeos/spark-plugs/snake.md":Un,"../../../../../docs/youmeos/spark-plugs/social-preview.md":Gn,"../../../../../docs/youmeos/spark-plugs/solitaire.md":Nn,"../../../../../docs/youmeos/spark-plugs/spark-plugs.md":Hn,"../../../../../docs/youmeos/spark-plugs/suggestion-box.md":Vn,"../../../../../docs/youmeos/spark-plugs/sys-monitor.md":Yn,"../../../../../docs/youmeos/spark-plugs/take-my-money.md":jn,"../../../../../docs/youmeos/spark-plugs/telescope.md":Xn,"../../../../../docs/youmeos/spark-plugs/terminal.md":qn,"../../../../../docs/youmeos/spark-plugs/tesseract.md":Qn,"../../../../../docs/youmeos/spark-plugs/tourguide.md":Kn,"../../../../../docs/youmeos/spark-plugs/trenchess.md":$n,"../../../../../docs/youmeos/spark-plugs/trophy-case.md":Jn,"../../../../../docs/youmeos/spark-plugs/u-nucleos.md":Zn,"../../../../../docs/youmeos/spark-plugs/welcome-u.md":et,"../../../../../docs/youmeos/spark-plugs/wizards-tower.md":nt,"../../../../../docs/youmeos/spark-plugs/wp-admin.md":tt,"../../../../../docs/youmeos/spark-plugs/xophz-lemonade-stand.md":at,"../../../../../docs/youmeos/spark-plugs/xophz-magic-formula.md":ot,"../../../../../docs/youmeos/user-guides/youmeos-user-guides-getting-started.md":it,"../../../../../docs/youmeos/user-guides/youmeos_user_guides_swiss_army_knife.md":st,"../../../../../docs/youmeos_nimbus_interaction-modes.md":rt}),p=n=>{const e=n.toLowerCase();return e.includes("start here")?"fal fa-stars":e.includes("blueprints")?"fal fa-drafting-compass":e.includes("user guides")?"fal fa-map-signs":e.includes("core engine")?"fal fa-microchip":e.includes("design system")?"fal fa-swatchbook":e.includes("roadmaps")?"fal fa-road":e.includes("ecosystem")?"fal fa-planet-ringed":e.includes("plugins")||e.includes("sparks")?"fal fa-plug":e.includes("reference")?"fal fa-books":e.includes("general")?"fal fa-book-spells":"fal fa-folder"},l=b(()=>Object.keys(c).map(n=>{const e=n.replace(yt,""),t=e.split("/"),o=t.pop()||"",a=o.replace(".md","");let r=a.split("-").map(f=>f.charAt(0).toUpperCase()+f.slice(1)).join(" "),d="03. Platform Docs",g="General";const M=o.toLowerCase()==="hello-world.md",U=t.length>=2&&["compass","youmeos"].includes(t[0].toLowerCase());M?(d="00. Welcome",g="Start Here"):U?(d=t[0].toLowerCase()==="youmeos"?"01. YouMeOS":"02. COMPASS",g=t[1]):t.length>0&&(d="03. Platform Docs",g=t[0]);const W=g.replace(/[-_]/g," ").split(" ").map(f=>f.charAt(0).toUpperCase()+f.slice(1).toLowerCase()).join(" ");let _="fal fa-file-alt",I="#62c9ff";if(W.toLowerCase()==="sparks"){const C=N().apps.find(G=>G.id===a);C&&(_=C.icon||_,I=C.color||I,r=C.title||r)}return{path:n,relativePath:e,title:r,category:W,root:d,icon:_,color:I}}).sort((n,e)=>n.root!==e.root?n.root.localeCompare(e.root):n.category!==e.category?n.category.localeCompare(e.category):n.title.localeCompare(e.title))),S=b(()=>{const n={};return l.value.forEach(e=>{const t=`${e.root}/${e.category}`;n[t]||(n[t]=[]),n[t].push(e)}),Object.keys(n).sort().map(e=>{const t=n[e],o=t[0].category;return{id:e,title:o,icon:p(o),children:t.map(a=>({id:a.path,title:a.title,icon:a.icon}))}})}),i=B("splash"),k=b(()=>l.value.find(n=>n.path===i.value)),P=b(()=>i.value==="splash"||!c[i.value]?null:c[i.value]),m=B(null);V(i,()=>{m.value&&(m.value.scrollTop=0)},{flush:"post"});const v=n=>{if(!n)return null;const e=n.toLowerCase(),t=e.replace(/^u-/,"").replace(/^xophz-/,"").replace(/\.md$/,"");let o=l.value.find(a=>(a.relativePath.split("/").pop()?.replace(".md","").toLowerCase()||"")===e);return o||(o=l.value.find(a=>(a.relativePath.split("/").pop()?.replace(".md","").toLowerCase()||"").replace(/^u-/,"").replace(/^xophz-/,"")===t),o)||(o=l.value.find(a=>a.path.toLowerCase().includes(e)||a.path.toLowerCase().includes(t)),o)?o:(o=l.value.find(a=>a.title.toLowerCase().includes(t)),o||null)},T=n=>{const e=v(n);e&&(i.value=e.path)},s=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;return s&&(T(s),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")),typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",n=>{const e=n.detail;e&&T(e)}),(n,e)=>{const t=A("x-spark-splash-action"),o=A("t-spark-splash"),a=A("u-window");return w(),D(a,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","brand-color":"#62c9ff",width:1e3,height:700,"default-nav-pinned":"","nav-items":S.value,"active-nav":i.value,"onUpdate:activeNav":e[0]||(e[0]=r=>i.value=r)},{"app-bar-title":y(()=>[j(X(k.value?.title||"Enchiridion"),1)]),default:y(()=>[L("div",mt,[P.value?(w(),F("div",{key:1,ref_key:"contentScrollEl",ref:m,class:"enchiridion-content fill-height custom-scrollbar",style:Y({"--brand-color":k.value?.color||"#62c9ff"})},[L("div",gt,[h(ct,{content:P.value},null,8,["content"])])],4)):(w(),D(o,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:y(()=>[h(ut)]),actions:y(()=>[h(R,{cols:"12",sm:"4"},{default:y(()=>[h(t,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),h(R,{cols:"12",sm:"4"},{default:y(()=>[h(t,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),h(R,{cols:"12",sm:"4"},{default:y(()=>[h(t,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1},8,["nav-items","active-nav"])}}}),Ct=z(ft,[["__scopeId","data-v-3177f1f2"]]);export{Ct as default};
