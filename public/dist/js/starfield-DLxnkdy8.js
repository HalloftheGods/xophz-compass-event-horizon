import{D as l,E as e}from"./youmeos-De2JppwU.js";import{l as M,q as x,d as y,A as z,e as A,p as S,w as m,t as P}from"./vendor-three-t6OjKSDq.js";import"./vendor-core-DYu_bGOt.js";import"./vendor-Bo03dMXr.js";import"./vendor-vuetify-DqpzkTaP.js";import"./vendor-echarts-CDgRBLbL.js";function q(p){const w=new M().load(p.youmeosBaseUrl+"/images/p_0.png"),r={color:{value:new x(16777215)},pointTexture:{value:w},scale:{value:1},opacity:{value:1}},C=new y({glslVersion:A,uniforms:r,vertexShader:`
      uniform float scale;
