import{y as l,z as e}from"./youmeos-BajDO0Wm.js";import{l as M,q as x,d as y,A as z,e as A,p as S,w as m,t as P}from"./vendor-three-PxNa-TFL.js";import"./vendor-core-BHRzyrMp.js";import"./vendor-d9g2IX_m.js";import"./vendor-vuetify-D3qDhgJd.js";import"./vendor-echarts-CsZ7-5qt.js";function q(p){const w=new M().load(p.youmeosBaseUrl+"/images/p_0.png"),r={color:{value:new x(16777215)},pointTexture:{value:w},scale:{value:1},opacity:{value:1}},C=new y({glslVersion:A,uniforms:r,vertexShader:`
      uniform float scale;
