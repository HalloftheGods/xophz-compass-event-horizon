import{n as l,r as e}from"./youmeos-DUUTw5yb.js";import{a9 as M,aq as x,aW as y,ad as z,aX as A,aa as S,ab as m,ae as P}from"./vendor-B3j3JalZ.js";import"./vuetify-BWfkLxJE.js";function W(p){const w=new M().load(p.youmeosBaseUrl+"/images/p_0.png"),a={color:{value:new x(16777215)},pointTexture:{value:w},scale:{value:1},opacity:{value:1}},b=new y({glslVersion:A,uniforms:a,vertexShader:`
      uniform float scale;
