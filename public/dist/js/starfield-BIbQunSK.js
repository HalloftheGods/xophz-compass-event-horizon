import{B as l,D as e}from"./youmeos-CeX6kKlh.js";import{l as M,q as x,d as y,A as z,e as A,p as S,w as m,t as P}from"./vendor-three-t6OjKSDq.js";import"./vendor-core-DD0IIVGP.js";import"./vendor-QbUGZ4yT.js";import"./vendor-vuetify-DGLhbi1q.js";import"./vendor-echarts-Dkaa2xiV.js";function q(p){const w=new M().load(p.youmeosBaseUrl+"/images/p_0.png"),r={color:{value:new x(16777215)},pointTexture:{value:w},scale:{value:1},opacity:{value:1}},C=new y({glslVersion:A,uniforms:r,vertexShader:`
      uniform float scale;
