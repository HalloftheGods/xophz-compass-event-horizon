import{y as l,z as e}from"./youmeos-FfomjJLU.js";import{l as M,q as x,d as y,A as z,e as A,p as S,w as m,t as P}from"./vendor-three-t6OjKSDq.js";import"./vendor-core-BCGDVfqk.js";import"./vendor-4eVlFIH5.js";import"./vendor-vuetify-BG23TbIb.js";import"./vendor-echarts-BpdSunPF.js";function q(p){const w=new M().load(p.youmeosBaseUrl+"/images/p_0.png"),r={color:{value:new x(16777215)},pointTexture:{value:w},scale:{value:1},opacity:{value:1}},C=new y({glslVersion:A,uniforms:r,vertexShader:`
      uniform float scale;
