...
\`\`\`
`,xn=`# WebGPU Shader Migration Plan
...
\`\`\`
`,_n=`# The w⁴ Protocol: A 4D Fractal Economic Operating System
...
\`\`\`
`,zn=["innerHTML"],Gn=_({__name:"x-markdown",props:{content:{}},setup(T){const p=T,v=h(()=>p.content?Ke.parse(p.content):"");return(d,x)=>(f(),W("div",{class:"x-markdown-container",innerHTML:v.value},null,8,zn))}}),Fn=I(Gn,[["__scopeId","data-v-c9651a1d"]]),Nn={class:"h-100 w-100",style:{position:"relative"}},Yn={class:"reading-pane mx-auto w-100 brand-styled-content"},Un="../../../docs/",Hn=_({__name:"enchiridion-app",setup(T){const p=Object.assign({"../../../docs/CHANGELOG.md":sn,"../../../docs/Home.md":rn,"../../../docs/architecture/asynchronous-cosmos.md":ln,"../../../docs/architecture/audio-engine.md":cn,"../../../docs/architecture/helios-modules.md":dn,"../../../docs/architecture/legacy-engine-mechanics.md":un,"../../../docs/architecture/nimbus-interaction-modes.md":pn,"../../../docs/architecture/pwa-desktop-node.md":mn,"../../../docs/architecture/starmap-federation.md":hn,"../../../docs/architecture/tesseract-4d-visualization.md":gn,"../../../docs/architecture/universal-os-vision.md":yn,"../../../docs/architecture/w4-protocol-fractal-os.md":wn,"../../../docs/architecture/window-management.md":fn,"../../../docs/architecture/youmeos-engine.md":vn,"../../../docs/guides/hello-world.md":bn,"../../../docs/guides/spark-development-guide.md":Sn,"../../../docs/guides/threejs-legacy-migration.md":kn,"../../../docs/guides/webgpu-migration.md":Tn,"../../../docs/guides/webgpu-shader-migration.md":xn,"../../../docs/guides/youmeos-getting-started.md":Pn,"../../../docs/guides/youmeos-swiss-army-knife.md":An,"../../../docs/reference/decentralized-pwa-model.md":Mn,"../../../docs/reference/dirt-digital-mineral-economy.md":Cn,"../../../docs/reference/nexus-knowledge-base.md":Ln,"../../../docs/reference/sephiroth-godhead-progression.md":On,"../../../docs/reference/storybrand-framework.md":Rn,"../../../docs/reference/storybrand-manifesto.md":Dn,"../../../docs/reference/tesseract-pricing.md":In,"../../../docs/reference/w4-protocol-economy.md":_n,"../../../docs/reference/w4-yellowlinks-whitepaper.md":Wn,"../../../docs/reference/web3-vision-roadmap.md":En,"../../../docs/reference/youmeos-compass-whitepaper.md":Bn,"../../../docs/sparks/alphabet-soup.md":$e,"../../../docs/sparks/app-launcher.md":Xe,"../../../docs/sparks/author-note.md":qe,"../../../docs/sparks/bazaar.md":je,"../../../docs/sparks/blackbox.md":Ve,"../../../docs/sparks/blackjack.md":He,"../../../docs/sparks/bomb-bag.md":Ue,"../../../docs/sparks/bubblegum.md":Ye,"../../../docs/sparks/bugnet.md":Ne,"../../../docs/sparks/cafeteria.md":Fe,"../../../docs/sparks/calculator.md":Ge,"../../../docs/sparks/chronos.md":ze,"../../../docs/sparks/cookie-jar.md":Be,"../../../docs/sparks/debug-console.md":Ee,"../../../docs/sparks/diego-lawfirm.md":We,"../../../docs/sparks/dodo-air.md":_e,"../../../docs/sparks/enchiridion.md":Ie,"../../../docs/sparks/fresh-mints.md":De,"../../../docs/sparks/gaea.md":Re,"../../../docs/sparks/generic-spark.md":Oe,"../../../docs/sparks/helios.md":Le,"../../../docs/sparks/holosweeper.md":Ce,"../../../docs/sparks/jukebox.md":Me,"../../../docs/sparks/lemon-aid.md":Ae,"../../../docs/sparks/local-produce.md":Pe,"../../../docs/sparks/logos.md":xe,"../../../docs/sparks/lunch-room.md":Te,"../../../docs/sparks/magic-cloak.md":ke,"../../../docs/sparks/magic-formula.md":Se,"../../../docs/sparks/media-drive.md":be,"../../../docs/sparks/midnight-nerd.md":ve,"../../../docs/sparks/minesweeper.md":fe,"../../../docs/sparks/moving-castle.md":we,"../../../docs/sparks/music-stream.md":ye,"../../../docs/sparks/my-compass.md":ge,"../../../docs/sparks/my-planner.md":he,"../../../docs/sparks/neon-notes.md":me,"../../../docs/sparks/nexus.md":pe,"../../../docs/sparks/noosphere.md":ue,"../../../docs/sparks/notepad.md":de,"../../../docs/sparks/nucleos.md":ce,"../../../docs/sparks/omega-source.md":le,"../../../docs/sparks/oscar.md":re,"../../../docs/sparks/paint.md":se,"../../../docs/sparks/polos.md":ie,"../../../docs/sparks/questbook.md":ae,"../../../docs/sparks/skiptrace.md":oe,"../../../docs/sparks/snake.md":te,"../../../docs/sparks/social-preview.md":ne,"../../../docs/sparks/solitaire.md":ee,"../../../docs/sparks/spark-plugs.md":J,"../../../docs/sparks/suggestion-box.md":Z,"../../../docs/sparks/swag-shop.md":K,"../../../docs/sparks/sys-monitor.md":Q,"../../../docs/sparks/take-my-money.md":$,"../../../docs/sparks/telescope.md":X,"../../../docs/sparks/terminal.md":q,"../../../docs/sparks/tesseract.md":j,"../../../docs/sparks/tourguide.md":V,"../../../docs/sparks/trenchess.md":H,"../../../docs/sparks/trophy-case.md":U,"../../../docs/sparks/webspark.md":Y,"../../../docs/sparks/welcome-u.md":N,"../../../docs/sparks/wizards-tower.md":F,"../../../docs/sparks/wp-admin.md":G,"../../../docs/sparks/yellow-links.md":z}),v=n=>{const e=n.toLowerCase();return e.includes("start here")?"fal fa-stars":e.includes("blueprints")?"fal fa-drafting-compass":e.includes("guides")?"fal fa-map-signs":e.includes("core engine")||e.includes("architecture")?"fal fa-microchip":e.includes("design system")?"fal fa-swatchbook":e.includes("roadmaps")?"fal fa-road":e.includes("ecosystem")?"fal fa-planet-ringed":e.includes("plugins")||e.includes("sparks")?"fal fa-plug":e.includes("reference")?"fal fa-books":e.includes("general")?"fal fa-book-spells":"fal fa-folder"},d=h(()=>Object.keys(p).map(n=>{const e=n.replace(Un,""),t=e.split("/"),o=t.pop()||"",a=o.replace(".md","");let r=a.split("-").map(m=>m.charAt(0).toUpperCase()+m.slice(1)).join(" "),i="05. Platform Docs",l="General";o.toLowerCase()==="hello-world.md"||o.toLowerCase()==="home.md"?(i="00. Welcome",l="Start Here"):t.length===0?(i="04. Reference",l="Reference"):t[0].toLowerCase()==="sparks"?(i="01. Sparks",l="Sparks"):t[0].toLowerCase()==="architecture"?(i="02. Architecture",l="Architecture"):t[0].toLowerCase()==="guides"?(i="03. User Guides",l="Guides"):t[0].toLowerCase()==="reference"?(i="04. Reference",l="Reference"):(i="05. Platform Docs",l=t[0]);const L=l.replace(/[-_]/g," ").split(" ").map(m=>m.charAt(0).toUpperCase()+m.slice(1).toLowerCase()).join(" ");let g="fal fa-file-alt",y="#62c9ff";if(L.toLowerCase()==="sparks"){const w=Qe().apps.find(B=>B.id===a);w&&(g=w.icon||g,y=w.color||y,r=w.title||r)}else o.toLowerCase()==="changelog.md"&&(r="YouMeOS Changelog",g="fal fa-history",y="#62c9ff");return{path:n,relativePath:e,title:r,category:L,root:i,icon:g,color:y}}).sort((n,e)=>n.root!==e.root?n.root.localeCompare(e.root):n.category!==e.category?n.category.localeCompare(e.category):n.title.localeCompare(e.title))),x=h(()=>{const n={};return d.value.forEach(e=>{const t=`${e.root}/${e.category}`;n[t]||(n[t]=[]),n[t].push(e)}),Object.keys(n).sort().map(e=>{const t=n[e],o=t[0].category;return{id:e,title:o,icon:v(o),children:t.map(a=>({id:a.path,title:a.title,icon:a.icon}))}})}),s=D("splash"),P=h(()=>d.value.find(n=>n.path===s.value)),A=h(()=>s.value==="splash"||!p[s.value]?null:p[s.value]),b=D(null);Ze(s,()=>{b.value&&(b.value.scrollTop=0)},{flush:"post"});const E=n=>{if(!n)return null;const e=n.toLowerCase(),t=e.replace(/^u-/,"").replace(/^xophz-/,"").replace(/\.md$/,"");let o=d.value.find(a=>(a.relativePath.split("/").pop()?.replace(".md","").toLowerCase()||"")===e);return o||(o=d.value.find(a=>(a.relativePath.split("/").pop()?.replace(".md","").toLowerCase()||"").replace(/^u-/,"").replace(/^xophz-/,"")===t),o)||(o=d.value.find(a=>a.path.toLowerCase().includes(e)||a.path.toLowerCase().includes(t)),o)?o:(o=d.value.find(a=>a.title.toLowerCase().includes(t)),o||null)},M=n=>{const e=E(n);e&&(s.value=e.path)},C=n=>{const e=n.detail;e&&M(e)};return Je(()=>{const n=typeof sessionStorage<"u"?sessionStorage.getItem("youmeos:enchiridion:open"):null;n&&(M(n),typeof sessionStorage<"u"&&sessionStorage.removeItem("youmeos:enchiridion:open")),typeof window<"u"&&window.addEventListener("youmeos:enchiridion:open",C)}),en(()=>{typeof window<"u"&&window.removeEventListener("youmeos:enchiridion:open",C)}),(n,e)=>{const t=S("x-spark-splash-action"),o=S("t-spark-splash"),a=S("u-window");return f(),O(a,{id:"enchiridion",title:"Enchiridion",icon:"fal fa-book-spells","brand-color":"#62c9ff",width:1e3,height:700,"default-nav-pinned":"","nav-items":x.value,"active-nav":s.value,"onUpdate:activeNav":e[0]||(e[0]=r=>s.value=r)},{"app-bar-title":u(()=>[tn(on(P.value?.title||"Enchiridion"),1)]),default:u(()=>[R("div",Nn,[A.value?(f(),W("div",{key:1,ref_key:"contentScrollEl",ref:b,class:"enchiridion-content fill-height custom-scrollbar",style:nn({"--brand-color":P.value?.color||"#62c9ff"})},[R("div",Yn,[c(Fn,{content:A.value},null,8,["content"])])],4)):(f(),O(o,{key:0,icon:"fal fa-book-spells",title:"Enchiridion",subtitle:"The Ultimate Handbook to the","subtitle-highlight":"Youniverse"},{background:u(()=>[c(an)]),actions:u(()=>[c(k,{cols:"12",sm:"4"},{default:u(()=>[c(t,{title:"Explore",description:"All the knowledge of the Youniverse",icon:"fal fa-compass","icon-color":"#62c9ff"})]),_:1}),c(k,{cols:"12",sm:"4"},{default:u(()=>[c(t,{title:"Learn",description:"Master the tools of the Youniverse",icon:"fal fa-book-open","icon-color":"#D9BE6F"})]),_:1}),c(k,{cols:"12",sm:"4"},{default:u(()=>[c(t,{title:"Dream",description:"Shape the future of your Youniverse",icon:"fal fa-sparkles","icon-color":"#22c55e"})]),_:1})]),_:1}))])]),_:1},8,["nav-items","active-nav"])}}}),nt=I(Hn,[["__scopeId","data-v-4cb6e9aa"]]);export{nt as default};
