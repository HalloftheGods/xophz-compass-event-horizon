import{y as l,z as e}from"./youmeos-CNzd7x_-.js";import{l as M,q as x,d as y,A as z,e as A,p as S,w as m,t as P}from"./vendor-three-PxNa-TFL.js";import"./vendor-core-BHRzyrMp.js";import"./vendor-Bpc7D26J.js";import"./vendor-vuetify-Bk4dheO_.js";import"./vendor-echarts-Cm8G4iFY.js";function q(p){const w=new M().load(p.youmeosBaseUrl+"/images/p_0.png"),r={color:{value:new x(16777215)},pointTexture:{value:w},scale:{value:1},opacity:{value:1}},C=new y({glslVersion:A,uniforms:r,vertexShader:`
      uniform float scale;
