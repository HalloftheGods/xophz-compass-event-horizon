...
function makeSolarSystem(){
	...
	//	mercury
	var mercuryOrbit = createSpaceRadius( KMToLY(55000000), /*0x90745D*/ 0x90745D );
	solarSystem.add( mercuryOrbit );
	var mercury = createPlanet( 55000000, 2439.7 );
	solarSystem.add( mercury );
	attachLegacyMarker( "Messages", mercury, 1.0, {min:3.4, max: 8.0} );	

	//	venus
	var venusOrbit = createSpaceRadius( KMToLY(108000000), /*0x9E4738*/ 0x9E4738 );
	solarSystem.add( venusOrbit );
	var venus = createPlanet( 108000000, 6051.8 );
	solarSystem.add( venus );
	attachLegacyMarker( "Relations", venus, 1.0, {min:3.6, max: 8.2} );	

	//	earth
	var earthOrbit = createSpaceRadius( KMToLY(150000000), /*0x887F98*/ 0x887F98 );
	...
	// 	new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/earth.png" )} ) 
	// );
	// earth.position.x = KMToLY(150000000);
	solarSystem.add( earth );

	earth.name = "Pictures";
	attachLegacyMarker( "Pictures", earth, 1.0, {min:3.8, max: 8.4} );
