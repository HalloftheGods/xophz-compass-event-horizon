...
function initSkybox( highres ){
	window.setLoadMessage("Loading internal stars")
	var r = window.youmeosBaseUrl + "/images/ss_skybox/";
	...
	var textureCube                  = THREE.ImageUtils.loadTextureCube( urls, undefined, window.setLoadMessage('I am Umeos. You~Me OS') );
