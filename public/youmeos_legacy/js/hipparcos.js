function loadStarData( dataFile, callback ){
	...
	window.setLoadMessage('Thank You for Everything');	
	xhr.addEventListener( 'load', function ( event ) {
		var parsed = JSON.parse( xhr.responseText );
		// console.log(parsed);
		if( callback ){		
			window.setLoadMessage("Parsing stellar data");	
			callback(parsed);			
		}
	}, false );
...
var datastarTexture0          = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/p_0.png" );
var datastarTexture1          = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/p_2.png" );
var datastarHeatVisionTexture = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + "/images/sharppoint.png" );

//	bright flashy named stars graphic
var starPreviewTexture        = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + '/images/star_preview.png', undefined, window.setLoadMessage("Hello World")	);
var starColorGraph            = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + '/images/star_color_modified.png' );
...
function generateHipparcosStars(){
	...
	var degToMonths = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
	...
	var starBaseTexture = THREE.ImageUtils.loadTexture( window.youmeosBaseUrl + '/images/starbase.png');
