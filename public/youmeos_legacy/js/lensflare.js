var textureFlare0 = THREE.ImageUtils.loadTexture(
  window.youmeosBaseUrl + "/images/lensflare/lensflare0.png"
);
var textureFlare1 = THREE.ImageUtils.loadTexture(
  window.youmeosBaseUrl + "/images/lensflare/lensflare1.png"
);
var textureFlare2 = THREE.ImageUtils.loadTexture(
  window.youmeosBaseUrl + "/images/lensflare/lensflare2.png"
);
var textureFlare3 = THREE.ImageUtils.loadTexture(
  window.youmeosBaseUrl + "/images/lensflare/lensflare3.png",
  null,
  undefined
);
...
function addStarLensFlare(x, y, z, size, overrideImage, hueShift) {
  ...
  var brightnessCalibration =
    1.25 -
    (Math.sqrt(
      Math.pow(lookupColor[0], 2) + Math.pow(lookupColor[1], 2) + Math.pow(lookupColor[2], 2)
    ) /
      255) *
      1.25;
