...
var postStarGradientLoaded = function () {
  ...
  gradientCanvas.getColor = function (percentage) {
    return this.getContext("2d", { willReadFrequently: true }).getImageData(
      0,
      percentage * gradientImage.height,
      1,
      1
    ).data;
  };
...
function initScene() {
  ...
  document
    ...
    .play()
    .catch(function (e) {
      console.log("Initial audio play failed (interaction required): ", e);
    });
